...
const UpdateStatusModal = memo(({ 
    ...
    return (
        <Modal
            ...
            okText={isCancelling ? 'Cancel Order' : 'Confirm'}
            cancelText="Close"
            okButtonProps={{
                className:
        ...
        >
            <div className="py-4">
                ...
                <Form form={form} layout="vertical">
                    <Form.Item
                        name="reason"
                        label={isCancelling ? 'Cancel Reason' : 'Note (Optional)'}
                        rules={[
                            {
                                required: isCancelling,
                                message: 'Please enter the cancel reason'
                            },
                            {
                                max: 500,
